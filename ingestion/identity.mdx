...
```mermaid
%%{init: {'theme':'base','themeVariables':{'actorBkg':'#14241b','actorBorder':'#22C55E','actorTextColor':'#ffffff','actorLineColor':'#4b5563','signalColor':'#cbd5e1','signalTextColor':'#e5e7eb','noteBkgColor':'#16A34A','noteTextColor':'#ffffff','noteBorderColor':'#4ADE80','sequenceNumberColor':'#06210f','lineColor':'#4ADE80'}}}%%
sequenceDiagram
    autonumber
