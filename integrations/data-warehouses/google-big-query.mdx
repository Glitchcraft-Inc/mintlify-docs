...
| BigQuery Job User | `roles/bigquery.jobUser` | Project | Run query jobs |
    ...
    **Grant dataset-level read access**
    ...
    After creating the service account, grant it read access on the specific dataset Actioneer should query. This follows the principle of least privilege — the service account can only read the datasets you explicitly authorize.
