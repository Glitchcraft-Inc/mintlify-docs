---
mode: "frame"
title: "Connect Google BigQuery | Actioneer Integration Guide"
sidebarTitle: "Google BigQuery"
icon: "/images/google-big-query.svg"
description: "Step-by-step guide to connect Google BigQuery to Actioneer. Set up a GCP service account with read-only access and start querying in under 15 minutes."
"og:title": "Connect Google BigQuery to Actioneer"
"og:description": "Grant read-only BigQuery access via a GCP service account. Query your datasets directly from Actioneer."
keywords: ["Google BigQuery integration", "BigQuery service account", "Actioneer data warehouse", "GCP read-only access", "BigQuery connection setup"]
---
