...
| | |
| :--- | :--- |
| &nbsp; **Prerequisites** | &nbsp; ClickHouse instance, Actioneer account |
...
<Steps>
  <Step title="Locate your ClickHouse connection details">
    ...
    **Self-hosted:** Use the hostname or IP address of your ClickHouse server.
    ...
    | :--- | :--- | :--- |
    | &nbsp; **Host** | &nbsp; Service overview / server config | &nbsp; `my-instance.clickhouse.cloud` |
    | &nbsp; **Port** | &nbsp; See port table below | &nbsp; `8443` or `8123` |
  ...
  <Step title="Connect ClickHouse in Actioneer">
    ...
    | &nbsp; Field | &nbsp; Value |
    | :--- | :--- |
    | &nbsp; **Connection Name** | &nbsp; e.g. `Production ClickHouse` |
    | &nbsp; **Host** | &nbsp; From Step 1 |
    | &nbsp; **Port** | &nbsp; From Step 1 |
