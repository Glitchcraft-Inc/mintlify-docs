---
mode: "frame"
title: "Connect ClickHouse | Actioneer Integration Guide"
sidebarTitle: "ClickHouse"
icon: "/images/clickhouse.svg"
description: "Step-by-step guide to connect ClickHouse to Actioneer. Create a read-only user, whitelist Actioneer's IP, and query your ClickHouse instance."
"og:title": "Connect ClickHouse to Actioneer"
"og:description": "Set up a read-only ClickHouse connection with a dedicated database user. Query your instance directly from Actioneer."
keywords: ["ClickHouse integration", "ClickHouse read-only user", "Actioneer data warehouse", "ClickHouse connection setup"]
---
