---
mode: "frame"
title: "Connect Amazon S3 | Actioneer Integration Guide"
sidebarTitle: "Amazon S3"
description: "Step-by-step guide to connect Amazon S3 to Actioneer. Attach a read-only IAM policy to a dedicated user and connect your S3 bucket."
"og:title": "Connect Amazon S3 to Actioneer"
"og:description": "Set up read-only S3 access with a scoped IAM policy. Query your bucket data directly from Actioneer."
keywords: ["Amazon S3 integration", "S3 IAM policy", "Actioneer data warehouse", "S3 read-only access", "S3 bucket connection"]
---
