---
mode: "frame"
title: "Connect Snowflake | Actioneer Integration Guide"
sidebarTitle: "Snowflake"
description: "Step-by-step guide to connect Snowflake to Actioneer. Create a least-privilege service user with a Programmatic Access Token for read-only warehouse access."
"og:title": "Connect Snowflake to Actioneer"
"og:description": "Set up a read-only Snowflake connection with a dedicated service user and PAT. Query your warehouse directly from Actioneer."
keywords: ["Snowflake integration", "Snowflake service user", "Actioneer data warehouse", "Snowflake PAT setup", "Snowflake read-only access"]
---
