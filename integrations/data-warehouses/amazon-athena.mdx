...
<Steps>
  <Step title="Note your Athena database details">
    Four values are needed from the AWS Console.
  ...
  <Step title="Create a dedicated IAM user with Athena permissions">
    ...
    <Accordion title="Quick setup with managed policies">
      For a faster (broader) setup, attach these three AWS managed policies to the IAM user instead of creating a custom policy:

      - `AmazonAthenaFullAccess`
      - `AmazonS3FullAccess`
      - `AWSGlueConsoleFullAccess`

      This grants more permissions than required. The custom policy above is recommended for production.
    </Accordion>
  </Step>
