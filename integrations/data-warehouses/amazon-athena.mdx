---
mode: "frame"
title: "Connect Amazon Athena | Actioneer Integration Guide"
sidebarTitle: "Amazon Athena"
icon: "/images/amazon-athena.svg"
description: "Step-by-step guide to connect Amazon Athena to Actioneer. Set up IAM credentials, configure Glue catalog access, and start querying attribution data in minutes."
"og:title": "Connect Amazon Athena to Actioneer"
"og:description": "Set up a read-only Athena connection with scoped IAM permissions. Query Glue catalog databases directly from Actioneer."
keywords: ["Amazon Athena integration", "Athena IAM setup", "Actioneer data warehouse", "AWS Glue catalog", "Athena read-only access"]
---
