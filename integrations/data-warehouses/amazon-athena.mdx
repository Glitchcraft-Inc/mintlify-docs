...
<Steps>
  ...
  <Step title="Create a dedicated IAM user with Athena permissions">
    ...
    <Accordion title="Quick setup with managed policies">
      ...
      These policies provide broader access than the custom policy. For tighter control over what Actioneer can access, use the custom policy in the previous step.
    </Accordion>
  </Step>
