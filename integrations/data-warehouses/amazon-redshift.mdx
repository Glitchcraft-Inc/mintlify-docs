...
<Steps>
  <Step title="Locate your Redshift cluster endpoint and database name">
    ...
    3. On the **General information** tab, copy the **Endpoint**. It follows the format `my-cluster.abc123.us-east-1.redshift.amazonaws.com:5439`. The address before the colon is the **Host**. The number after the colon is the **Port**.
