---
mode: "frame"
title: "Connect Amazon Redshift | Actioneer Integration Guide"
sidebarTitle: "Amazon Redshift"
icon: "/images/amazon-redshift.svg"
description: "Step-by-step guide to connect Amazon Redshift to Actioneer. Create a read-only database user, whitelist Actioneer's IP, and start querying your cluster."
"og:title": "Connect Amazon Redshift to Actioneer"
"og:description": "Set up a read-only Redshift connection with a dedicated database user. Query your cluster directly from Actioneer."
keywords: ["Amazon Redshift integration", "Redshift read-only user", "Actioneer data warehouse", "Redshift IP whitelisting", "Redshift connection setup"]
---
...
<Steps>
  ...
  <Step title="Allow Actioneer's IP address">
    ...
    4. Add a rule: Type = **Redshift**, Port = **5439**, Source = **Custom** → `35.244.14.238/32`.
    5. Click **Save rules**.
