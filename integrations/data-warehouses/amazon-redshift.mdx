...
| | |
| :--- | :--- |
| &nbsp; **Prerequisites** | &nbsp; AWS account with Redshift, Actioneer account |
...
<Steps>
  <Step title="Locate your Redshift cluster endpoint and database name">
    ...
    | :--- | :--- | :--- |
    | &nbsp; **Host** | &nbsp; Cluster endpoint (no port) | &nbsp; `my-cluster.redshift.amazonaws.com` |
  ...
  <Step title="Connect Redshift in Actioneer">
    ...
    | &nbsp; Field | &nbsp; Value |
    | :--- | :--- |
    | &nbsp; **Connection Name** | &nbsp; e.g. `Production Redshift` |
    | &nbsp; **Host** | &nbsp; From Step 1 |
    | &nbsp; **Port** | &nbsp; `5439` |
