---
mode: "frame"
title: "Connect Databricks | Actioneer Integration Guide"
sidebarTitle: "Databricks"
description: "Step-by-step guide to connect Databricks to Actioneer. Use a Personal Access Token and Unity Catalog permissions for read-only SQL Warehouse access."
"og:title": "Connect Databricks to Actioneer"
"og:description": "Set up a read-only Databricks connection via SQL Warehouse and Unity Catalog. Query your lakehouse directly from Actioneer."
keywords: ["Databricks integration", "Databricks SQL Warehouse", "Actioneer data warehouse", "Unity Catalog permissions", "Databricks PAT setup"]
---
