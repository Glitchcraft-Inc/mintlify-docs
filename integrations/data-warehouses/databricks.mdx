...
<Steps>
  <Step title="Locate your SQL Warehouse connection details">
    ...
    | :--- | :--- | :--- |
    | **Server Hostname** | Connection Details tab | `adb-123456.azuredatabricks.net` |
    | **HTTP Path** | Connection Details tab | `/sql/1.0/warehouses/abc123` |
  </Step>
  ...
  <Step title="Connect Databricks in Actioneer">
    ...
    | **Server Hostname** | From Step 1 — **do not include `https://`** |
    | **Schema / Database** | From Step 3 (e.g., `default`) |
