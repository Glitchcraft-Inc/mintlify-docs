...
| **Access granted** | Read-only access to the specified spreadsheet via the Google Sheets API |
...
<Steps>
  ...
  <Step title="Connect Google Sheets in Actioneer">
    1. In the same connection form from Step 2, complete the remaining fields:
