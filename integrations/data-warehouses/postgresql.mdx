---
mode: "frame"
title: "Connect PostgreSQL | Actioneer Integration Guide"
sidebarTitle: "PostgreSQL"
description: "Step-by-step guide to connect PostgreSQL to Actioneer. Create a read-only database user, whitelist Actioneer's IP, and start querying your PostgreSQL instance."
"og:title": "Connect PostgreSQL to Actioneer"
"og:description": "Set up a read-only PostgreSQL connection with a dedicated database user. Query your instance directly from Actioneer."
