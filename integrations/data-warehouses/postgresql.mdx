...
| | |
| :--- | :--- |
| &nbsp; **Prerequisites** | &nbsp; PostgreSQL instance, Actioneer account |
...
<Steps>
  <Step title="Locate your PostgreSQL connection details">
    ...
    **Self-hosted:** Use the hostname or IP address of your PostgreSQL server. The default port is `5432`.
    ...
    | :--- | :--- | :--- |
    | &nbsp; **Host** | &nbsp; Provider console / server config | &nbsp; `my-db.rds.amazonaws.com` |
    | &nbsp; **Port** | &nbsp; Provider console / server config | &nbsp; `5432` |
    | &nbsp; **Database Name** | &nbsp; Provider console or `\l` | &nbsp; `analytics` |
  </Step>
  ...
  <Step title="Connect PostgreSQL in Actioneer">
    ...
    | &nbsp; Field | &nbsp; Value |
    | :--- | :--- |
    | &nbsp; **Connection Name** | &nbsp; e.g. `Production PostgreSQL` |
    | &nbsp; **Host** | &nbsp; From Step 1 |
    | &nbsp; **Port** | &nbsp; From Step 1 |
